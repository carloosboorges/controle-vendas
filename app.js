...
// ==========================================
// MODO PRIVACIDADE (OLHINHO MÁGICO)
// ==========================================
...
function render() {
  ...
  if (elHistTotal) {
    ...
    elHistTotal.innerHTML = `${historicoFormatado} <span style="cursor:pointer; margin-left:8px; font-size:20px; vertical-align:middle; filter:drop-shadow(0 2px 4px rgba(0,0,0,0.3));" onclick="toggleOcultarHistorico()" title="Ocultar/Mostrar Valor">${eyeIconHist}</span>`;
  }
