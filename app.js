...
// ==========================================
// PREVENÇÃO DE ERROS DO NAVEGADOR
// ==========================================
let authToken = null;
let refreshToken = null;
let ocultarHistoricoTotal = false;
let ocultarPeriodos = false;

try {
  authToken = localStorage.getItem("vendas_auth_token") || null;
  refreshToken = localStorage.getItem("vendas_refresh_token") || null;
  ocultarHistoricoTotal = localStorage.getItem("putz_ocultar_historico") === "true";
  ocultarPeriodos = localStorage.getItem("putz_ocultar_periodos") === "true";
} catch(e) {
  console.warn("Acesso ao cache bloqueado, rodando em modo seguro.");
}

function toggleOcultarHistorico() {
  ocultarHistoricoTotal = !ocultarHistoricoTotal;
  try { localStorage.setItem("putz_ocultar_historico", ocultarHistoricoTotal); } catch(e) {}
  render();
}
...
function toggleOcultarPeriodos(e) {
  ...
  try { localStorage.setItem("putz_ocultar_periodos", ocultarPeriodos); } catch(e) {}
  render();
}
...
} catch(e) { console.warn("BroadcastChannel não suportado."); }
...
function render() {
  ...
  if (periodosEl) {
    ...
    // Formatação segura dos períodos
