...
// Variáveis do Olhinho Mágico (Privacidade)
...
function render() {
  ...
  document.getElementById("historicoTotal").innerHTML = `Total do histórico: ${historicoFormatado} <span style="cursor:pointer; margin-left:6px; font-size:22px; vertical-align:middle; filter:drop-shadow(0 2px 4px rgba(0,0,0,0.3));" onclick="toggleOcultarHistorico()" title="Ocultar/Mostrar Valor">${eyeIconHist}</span>`;
